...
namespace BSK.Models
{
    ...
    public class DB : DbContext
    {
        static String ConnectionString = "Server=tedecon.nazwa.pl;User ID=tedecon_2;Password=B$KMiloscMa;Database=tedecon_2;port=5432;MultipleActiveResultSets=true";
        public DB()
